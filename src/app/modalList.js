const modalContentList = [
    ...
    [
        {
            "title" : "Lang & theme",
            "content": "<h3>Lang</h3><div style=\"display: flex;flex-wrap: wrap;text-align: center;\"><div class=\"langItem\"><img class=\"circle selected\" src=\"./src/img/png/flagUk.png\" alt=\"\"><p style=\"color: var(--TextColor2);font-weight: bold;text-decoration:underline;\">English</p></div><div class=\"langItem\" onclick=\"switchLang(1)\"><img class=\"circle\" src=\"./src/img/png/flagFr.png\" alt=\"\"><p>Français</p></div><div class=\"langItem\" onclick=\"switchLang(2)\"><img class=\"circle\" src=\"./src/img/png/flagEs.png\" alt=\"\"><p>Español</p></div><div class=\"langItem\" onclick=\"switchLang(3)\"><img class=\"circle\" src=\"./src/img/png/flagDeu.png\" alt=\"\"><p>Deutsch</p></div></div><br><br><h3>Color Theme</h3><div style=\"display: flex\"><p>Deep</p><div id=\"sw1\" class=\"switch\" style=\"margin: 0 15px;\" onclick=\"switchTheme('sw1')\"><div class=\"switchBall\"></div></div><p>Light</p></div><br><div style=\"display: flex;flex-direction: row-reverse;\"><button class=\"rememberButton\" onclick=\"remember(0)\">Remember</button></div>"
        },
        {
            "title" : "Langue & thème",
            "content": '<h3>Langue</h3><div style="display: flex;flex-wrap: wrap;text-align: center;"><div class="langItem" onclick="switchLang(0)"><img class="circle" src="./src/img/png/flagUk.png" alt=""><p>English</p></div><div class="langItem"><img class="circle selected" src="./src/img/png/flagFr.png" alt=""><p style="color: var(--TextColor2);font-weight: bold;text-decoration:underline;">Français</p> </div><div class="langItem" onclick="switchLang(2)"><img class="circle" src="./src/img/png/flagEs.png" alt=""><p>Español</p></div><div class="langItem" onclick="switchLang(3)"><img class="circle" src="./src/img/png/flagDeu.png" alt=""><p>Deutsch</p></div></div><br><br><h3>Couleur</h3><div style="display: flex"><p>Sombre</p><div id="sw1" class="switch" style="margin: 0 15px;" onclick="switchTheme(\'sw1\')"><div class="switchBall"></div></div><p>Clair</p></div><br><div style="display: flex;flex-direction: row-reverse;"><button class="rememberButton" onclick="remember(1)">S\'en souvenir</button></div>'
        },
        {
            "title" : "Idioma y tema",
            "content": '<h3>Idioma</h3><div style="display: flex;flex-wrap: wrap;text-align: center;"><div class="langItem"onclick="switchLang(0)"><img class="circle" src="./src/img/png/flagUk.png" alt=""><p>English</p></div><div class="langItem"onclick="switchLang(1)"><img class="circle" src="./src/img/png/flagFr.png" alt=""><p>Français</p></div><div class="langItem"><img class="circle selected" src="./src/img/png/flagEs.png" alt=""><p style="color: var(--TextColor2);font-weight: bold;text-decoration:underline;">Español</p></div><div class="langItem" onclick="switchLang(3)"><img class="circle" src="./src/img/png/flagDeu.png" alt=""><p>Deutsch</p></div></div><br><br><h3>tema del color</h3><div style="display: flex"><p>oscuro</p><div id="sw1" class="switch" style="margin: 0 15px;" onclick="switchTheme(\'sw1\')"><div class="switchBall"></div></div><p>claro</p></div><br><div style="display: flex;flex-direction: row-reverse;"><button class="rememberButton" onclick="remember(2)">Recordando</button></div>'
        }
    ],
    [
        {
