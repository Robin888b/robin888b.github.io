const pageTranslation = [
    [
        {
            ...
            "pageText" : 'Hy 👋 <br>My name is Robin; I speak french and try to learn english ≈ 20%<br>I\'m 20Yo (2004/11/04).<br>I learn to draw🎨 and program💻 <br>what more to say about me ?<br><br>i\'m a <span class="SpanInfo" onclick="toggleModal(0,0)">gay</span> <span class="SpanInfo" onclick="toggleModal(0,1)">furry</span> <span class="spoiler" id="sp1" onclick="toggleSpoiler(\'sp1\')">(my fursona is Raven Spart)</span>, a Highly sensitive and shy person and a music and dance lover <span class="spoiler" id="sp2" onclick="toggleSpoiler(\'sp2\')">(i currently practice dance in club 1.5 hours per weeks + 1 hours of figure skating)</span>'
        },
        {
        ...
        },
        {
            ...
            "pageText" : 'Hola 👋<br>mi nombre es Robin; hablo francés y trato de aprender inglés ≈ 20%.<br>Actualmente tengo 20 años (04/11/2004)<br>Aprendo a dibujar🎨 y a programar💻<br>¿qué más decir de mí?<br><br>soy un <span class="SpanInfo" onclick="toggleModal(2,1)">furry</span> <span class="SpanInfo" onclick="toggleModal(2,0)">gay</span> <span class="spoiler" id="sp1" onclick="toggleSpoiler(\'sp1\')">(mi fursona es Raven Spart)</span>, una persona muy sensible y tímida y amante de la música y el baile <span class="spoiler" id="sp2" onclick="toggleSpoiler(\'sp2\')">(actualmente practico la danza en club 1.5 horas por semana + 1 horas de patinaje artistico)</span>'
        }
    ],
    ...
    [
        {
            "menuText": '<li class="headerLink"><a href="./index.html">About me</a></li><li class="headerLink selectedHeaderLink"><p>Social</p></li><li class="headerLink"><a href="./gallery.html">Gallery</a></li><li class="headerLink"><button onclick="toggleModal(0,3)" >Lang & theme</button></a></li><li class="headerLink"><button onclick="toggleModal(0,4)">Credits</button></li>',
        ...
        {
            "menuText": '<li class="headerLink"><a href="./index.html">A propos</a></li><li class="headerLink selectedHeaderLink"><p>Réseaux</p></li><li class="headerLink"><a href="./gallery.html">Gallerie</a></li><li class="headerLink"><button onclick="toggleModal(1,3)" >Lang & theme</button></a></li><li class="headerLink"><button onclick="toggleModal(1,4)">Crédits</button></li>',
        ...
        {
            "menuText": '<li class="headerLink"><a href="./index.html">Sobre mí</a></li><li class="headerLink selectedHeaderLink"><p>Redes sociales</p></li><li class="headerLink"><a href="./gallery.html">Galería</a></li><li class="headerLink"><button onclick="toggleModal(2,3)" >Lang & theme</button></a></li><li class="headerLink"><button onclick="toggleModal(2,4)">Créditos</button></li>',
