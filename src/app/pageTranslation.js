    ...
    [
        {
            ...
            "pageText" : 'Hy 👋 <br>My name is Robin; I speak french and try to learn english ≈ 20%<br>I\'m 19Yo (2004/11/04).<br>I learn to draw🎨 and program💻 <br>what more to say about me ?<br><br>i\'m a <span class="SpanInfo" onclick="toggleModal(0,0)">gay</span> <span class="SpanInfo" onclick="toggleModal(0,1)">furry</span> <span class="spoiler" id="sp1" onclick="toggleSpoiler(\'sp1\')">(my fursona is Raven Spart)</span>, a Highly sensitive and shy person and a music and dance lover <span class="spoiler" id="sp2" onclick="toggleSpoiler(\'sp2\')">(i currently practice dance in club 1.5 hours per weeks + 1 hours of figure skating)</span>'
        },
        {
        ...
        },
        {
            ...
            "pageText" : 'Hola 👋<br>mi nombre es Robin; hablo francés y trato de aprender inglés ≈ 20%.<br>Actualmente tengo 19 años (04/11/2004)<br>Aprendo a dibujar🎨 y a programar💻<br>¿qué más decir de mí?<br><br>soy un <span class="SpanInfo" onclick="toggleModal(2,1)">furry</span> <span class="SpanInfo" onclick="toggleModal(2,0)">gay</span> <span class="spoiler" id="sp1" onclick="toggleSpoiler(\'sp1\')">(mi fursona es Raven Spart)</span>, una persona muy sensible y tímida y amante de la música y el baile <span class="spoiler" id="sp2" onclick="toggleSpoiler(\'sp2\')">(actualmente practico la danza en club 1.5 horas por semana + 1 horas de patinaje artistico)</span>'
        }
    ],
